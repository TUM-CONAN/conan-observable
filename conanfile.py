...
class observableConan(ConanFile):
    ...
    def source(self):
        # tools.get("https://github.com/ddinu/observable/archive/refs/tags/%s.tar.gz" % self.version, strip_root=True,
        #           destination=self._source_subfolder)

        tools.get("https://github.com/ddinu/observable/archive/refs/heads/master.tar.gz", strip_root=True,
                  destination=self._source_subfolder)
    ...
    def package(self):
        ...
        self.copy("*.hpp", src=os.path.join(self._source_subfolder, "observable", "include"), dst="include")
